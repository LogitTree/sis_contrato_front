            ...
            <div style={layoutStyles.card}>
                ...
                <div style={{ overflowX: "auto" }}>
                    <table style={{ ...tableStyles.table, tableLayout: "fixed" }}>
                        <thead>
                            <tr>
                                <th style={{ ...tableStyles.th, width: "60%" }}>Produto</th>
                                <th style={{ ...tableStyles.th, width: 90, textAlign: "right" }}>
                                    Disponível
                                </th>
                                <th style={{ ...tableStyles.th, width: 90, textAlign: "right" }}>
                                    Reservado
                            ...
                            {rows.map((r, index) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <td style={{ ...tdRight, lineHeight: 1.2 }}>
                                            <div>
                                                <span style={{ fontSize: 11, color: "#94a3b8" }}>Médio:</span>{" "}
                                                <strong>{formatMoneyBR(r.custo_medio)}</strong>
                                            </div>

                                            <div style={{ marginTop: 2 }}>
                                                <span style={{ fontSize: 11, color: "#94a3b8" }}>Último:</span>{" "}
                                                {formatMoneyBR(r.ultimo_custo)}
                                            </div>
                                        </td>
