    ...
    async function loadOrgao() {
      try {
        ...
        setForm({
          ...
          tipo: data.tipo ?? "",
          esfera: (data.esfera ?? "MUNICIPAL") as OrgaoForm["esfera"],
      ...
      <div style={layoutStyles.header}>
        <div>
          ...
          <div style={{ fontSize: 13, color: "#64748b", marginTop: 4 }}>
            Atualize os dados do órgão para manter os contratos organizados.
          </div>
        </div>
      </div>
          ...
          <div style={sectionStyle}>
            ...
            <div style={grid3City}>
              ...
              <div style={formStyles.field}>
                ...
                <div style={{ fontSize: 12, color: "#94a3b8" }}>(auto)</div>
              </div>
            </div>
          </div>
