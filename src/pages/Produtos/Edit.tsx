    ...
    return (
      <div style={layoutStyles.page}>
        ...
        <div style={layoutStyles.card}>
          <div style={{ color: "#64748b", fontSize: 13 }}>Aguarde...</div>
        </div>
      </div>
    );
  }
    ...
    <div style={layoutStyles.page}>
      <div style={layoutStyles.header}>
        <div>
          <h1 style={layoutStyles.title}>Editar Produto</h1>
          <div style={{ fontSize: 13, color: "#64748b", marginTop: 4 }}>
            Atualize informações, classificação e valores.
          </div>
        </div>
      </div>
        ...
        <form onSubmit={handleSubmit} style={formStyles.form}>
          ...
          <div style={sectionCard}>
            <div style={sectionHeaderRow}>
              ...
              <div style={inlineHint}>Identificação e detalhes</div>
            </div>
            <div style={divider} />
          ...
          <div style={sectionCard}>
            <div style={sectionHeaderRow}>
              ...
              <div style={inlineHint}>Grupo e subgrupo</div>
            </div>
            <div style={divider} />
          ...
          <div style={sectionCard}>
            <div style={sectionHeaderRow}>
              ...
              <div style={inlineHint}>Preços e custos (R$)</div>
            </div>
            <div style={divider} />
          ...
          <div style={sectionCard}>
            <div style={sectionHeaderRow}>
              ...
              <div style={inlineHint}>Status e parâmetros</div>
            </div>
            <div style={divider} />
