...
import { FiEye, FiPlus, FiRefreshCcw, FiSearch } from "react-icons/fi";
  ...
  return (
    <PageShell>
      ...
      >
        ...
        >
          ...
          <div>
            ...
            >
              <option value="">
                {loadingFormas ? "Carregando..." : "Todas"}
              </option>
      ...
      <DataCard
        ...
        subtitle="Relação das vendas realizadas no PDV."
      >
        <div
          style={{
            overflowX: "auto",
              ...
              {loading ? (
                ...
                vendas.map((venda) => (
                  ...
                  >
                    ...
                    <td style={tdStyle}>
                      <strong>{money(venda.valor_total)}</strong>
                    </td>
                    ...
                    >
                      <button
                        ...
                        onClick={() =>
                          navigate(`/vendadireta/${venda.id}/editar`)
                        }
                      >
                        <FiEye size={15} />
                      </button>
